...
export declare const checkIfResizable: (resizeDisabledConditions: DraggingDisabledConditions | null, event: CalendarEvent) => boolean;
export declare const isSameMonth: (date?: DateTime) => boolean;
export declare const getCurrentTime: (timezone: string | undefined) => DateTime;
