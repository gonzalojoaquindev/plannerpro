...
export declare enum CALENDAR_EVENT_TYPE {
    EVENT = "EVENT",
    TASK = "TASK"
}
...
export type OnEventDragFinishFunc = (prevEvent: CalendarEvent, updatedEvent: CalendarEvent, events: any, resetPosition?: any) => void;
