...
import { Callbacks, Colors, Config, DraggingDisabledConditions, EventLayout, ShowMoreEvents, Style } from '../common/interface';
...
declare const StoreProvider: ({ children, ...props }: any) => JSX.Element;
